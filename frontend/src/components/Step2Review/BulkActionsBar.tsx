        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative" ref={addressMenuRef}>
            ...
            >
              ...
              <span className="hidden sm:inline">Change Ship From</span>
              <span className="sm:hidden">Ship From</span>
            </button>

            {showAddressMenu && (
              <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-10 min-w-[200px] max-w-[calc(100vw-2rem)]">
                {savedAddresses.length === 0 ? (
                  <div className="px-4 py-2 text-xs md:text-sm text-gray-500">
                    No saved addresses
                  </div>
                ) : (
                  savedAddresses.map((address) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-2 text-xs md:text-sm text-gray-700 hover:bg-gray-50 first:rounded-t-lg last:rounded-b-lg"
                    >
          ...
          <button
            ...
            disabled={isLoading}
            className="flex items-center gap-2 px-3 py-1.5 text-xs md:text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-50"
          >
